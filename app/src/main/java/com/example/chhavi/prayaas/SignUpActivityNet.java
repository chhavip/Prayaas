...
public class SignUpActivityNet extends Activity {
    private static final String TAG = SignUpActivityNet.class.getSimpleName();
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                if (!name.isEmpty() && !email.isEmpty() && !password.isEmpty()) {
                    ...
                    cv.put(PrayaasContract.USER_TABLE_NAME_COL, name);
